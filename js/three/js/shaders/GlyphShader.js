...
THREE.GlyphShader = {
	...
	fragmentShader: [
		...
		"void main() {",
			...
			"    srcHSV = floor(srcHSV * vec3(8, 10, 3)) / vec3(8, 10, 3);",
            ...
            "    float sat = srcHSV.y < 0.3 ? 0.0 : 1.0;",
			"    vec4 srcColor0 = vec4(hsv2rgb(vec3(srcHSV.x, sat, dBright.x)), 1);",
			"    vec4 srcColor1 = vec4(hsv2rgb(vec3(srcHSV.x, sat, dBright.y)), 1);",
    "#endif",
